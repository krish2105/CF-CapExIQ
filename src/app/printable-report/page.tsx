  ...
  return (
    <div className="space-y-6 bg-background text-foreground p-6 min-h-screen">
      ...
      <div className="flex items-center justify-between border-b border-border pb-4 print:hidden">
        ...
        <button
          onClick={handlePrint}
          className="px-5 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs font-bold flex items-center gap-2 shadow-lg shadow-cyan-500/20"
        >
      ...
      <div className="max-w-4xl mx-auto space-y-8 bg-card p-8 rounded-2xl border border-border print:bg-white print:text-black print:p-0 print:border-none print:shadow-none">
        {/* Document Header */}
        <div className="border-b border-border print:border-black pb-6 space-y-2">
          <div className="flex justify-between items-start">
            <div>
              <span className="text-xs font-bold text-primary uppercase tracking-widest print:text-cyan-800">
                CapExIQ Capital Investment Report
              </span>
              <h1 className="text-2xl font-bold tracking-tight mt-1 print:text-black text-foreground">
            ...
            <div className="text-right text-xs font-mono text-muted-foreground print:text-gray-700">
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-bold text-foreground print:text-black uppercase tracking-wider border-b border-border print:border-black pb-1">
            1. Executive Summary & Recommendation
          </h2>
          <div className="p-4 rounded-xl bg-muted/60 print:bg-gray-100 border border-border print:border-gray-300 text-xs leading-relaxed space-y-2">
            <div className="flex justify-between items-center font-bold">
              <span className="text-foreground print:text-black">Recommended Action:</span>
              <span className="text-success print:text-emerald-800">{metrics.decisionStatus}</span>
            </div>
        ...
        <div className="space-y-3">
          ...
          <table className="w-full text-left text-xs font-mono border-collapse print:text-black text-foreground">
            <thead>
              <tr className="bg-muted print:bg-gray-200 border-b border-border print:border-black">
            ...
            <tbody className="divide-y divide-border print:divide-gray-300">
              ...
              <tr>
                ...
                <td className="py-2 px-3 font-bold text-purple-600 dark:text-purple-400 print:text-black">{formatPercent(metrics.mirr)}</td>
              ...
              <tr>
                ...
                <td className="py-2 px-3 font-bold text-amber-600 dark:text-amber-400 print:text-black">
            ...
            <table className="w-full text-left text-xs font-mono border-collapse print:text-black text-foreground">
              ...
              <tbody className="divide-y divide-border print:divide-gray-300">
                ...
                <tr>
                  ...
                  {yearlyCashFlows.map((y) => (
                    <td key={y.year} className="py-1.5 px-2 text-right text-amber-600 dark:text-amber-400 print:text-black">
                ...
                <tr className="bg-muted/50 font-bold print:bg-gray-100">
                  ...
                  {yearlyCashFlows.map((y) => (
                    <td key={y.year} className="py-2 px-2 text-right text-success print:text-black font-extrabold">
                ...
                <tr>
                  ...
                  {yearlyCashFlows.map((y) => (
                    <td key={y.year} className="py-1.5 px-2 text-right text-purple-600 dark:text-purple-400 print:text-black font-bold">
        ...
        <div className="space-y-4 pt-4 border-t border-border print:border-black">
          <h2 className="text-sm font-bold text-foreground print:text-black uppercase tracking-wider">
          ...
          <div className="grid grid-cols-2 gap-8 pt-4">
            <div className="border-t border-dashed border-foreground/40 print:border-black pt-2 space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground print:text-gray-600">NovaRetail GCC • Investment Committee Chair</p>
            ...
            <div className="border-t border-dashed border-foreground/40 print:border-black pt-2 space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground print:text-gray-600">NovaRetail GCC • Board Member</p>
              <div className="text-[10px] font-mono text-muted-foreground print:text-black pt-4">Signature: __________________________</div>
            </div>
          </div>
        </div>
        ...
        {/* Footer Notes */}
        <div className="pt-4 border-t border-border print:border-black flex justify-between items-center text-[10px] text-muted-foreground print:text-gray-600 font-mono">
