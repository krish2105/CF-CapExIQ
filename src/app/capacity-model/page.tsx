    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass-panel p-4 rounded-2xl border border-border">
          ...
          <p className="text-lg font-bold text-purple-400 mt-1">{res.laborSavingFteEquivalent} FTEs</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-card border border-border rounded-lg px-3 py-2 text-xs text-foreground focus:outline-none focus:border-primary font-mono"
            />
          </div>
