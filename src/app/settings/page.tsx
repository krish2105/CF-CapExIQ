...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {savedNotice && (
        <div className="p-3 rounded-card bg-success/10 border border-success/30 text-success text-xs font-bold flex items-center gap-2">
      ...
      <div className="glass-panel p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
          <label className="flex items-center justify-between p-3 rounded-card bg-card border border-border text-xs cursor-pointer hover:bg-muted/50 transition-colors">
